...
class BlockChainRepositoryImpl @Inject constructor(): BlockchainRepository {
    override suspend fun currentHashRateGigaHashes(): Long {
        return 0L
    }

    override suspend fun getDifficulty(): BigDecimal {
        return BigDecimal.ZERO
    }

    override suspend fun getBlockCount(): Long {
        return 0L
    }
    ...
    override suspend fun getGeneralStats(): Stats? {
        return null
    }
...
//
//    override suspend fun getGeneralStats(): Stats = chartingApi.getStats()
//
